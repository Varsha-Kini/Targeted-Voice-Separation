...
def cfg():
    # Base configuration
    model_config = {"model_base_dir" : "/content/drive/MyDrive/BE_PROJECT/checkpoints", # Base folder for model checkpoints
                    "log_dir" : "/content/drive/MyDrive/BE_PROJECT/logs", # Base folder for logs files
                    ...
                    'ccmixter_path':"/content/drive/MyDrive/BE_PROJECT/wave_dataset/CCMixter_latest.xml"
                    }
    seed=1337
